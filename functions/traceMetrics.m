function [scn_u, scn_el, scn_ss_ic, metrics, exitflags] = traceMetrics(system, param, parameterIndex, maxVal, minVal, N, elements_to_test)
%%
...
%%     
   for ii = 1:N
      ...
      metrics(ii) = calculateMetrics(system, scn_u(ii,:), scn_el(ii,:), ss_ic, elements_to_test);
   end 
